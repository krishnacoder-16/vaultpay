...
export default function UnauthorizedPage() {
  ...
  // Dynamically determine secure return path based on sovereign role
  const returnPath = user?.role === 'ADMIN' ? '/settings' : '/invoices';
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#fafbfc] px-6 py-12 text-slate-900">
      ...
      <div className="relative w-full max-w-md border border-slate-200/80 bg-white p-8 rounded-2xl text-center shadow-[0_1px_3px_rgba(0,0,0,0.02),0_12px_32px_rgba(148,163,184,0.08)] z-10">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-red-550 text-red-600 border border-red-100 mb-6 shadow-sm">
        ...
        <p className="mt-3 text-xs font-semibold text-slate-500 leading-relaxed">
          Your credentials do not grant access to this administrative section. Please return to your secure workspace.
        </p>
